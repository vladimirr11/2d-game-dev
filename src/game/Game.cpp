...
void Game::deinit() { _textContainer->unloadText(helloSDLText.textId); }
...
void Game::handleEvent(const InputEvent& event) {
    ...
    case Keyboard::KEY_B:
        _textContainer->createText("How it is going?", Colors::ORANGE, gFontId, helloSDLText.textId,
                                   helloSDLText.width, helloSDLText.height);
        break;
